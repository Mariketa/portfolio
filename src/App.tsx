...
const projects: Project[] = [
  {
    ...
    lms: 'Moodle',
    result: 'курс позволяет последовательно отработать процедуру поверки: от изучения оборудования и внешнего осмотра до выполнения измерений и заполнения электронного протокола с расчетами.',
    gallery: [
  ...
  },
  {
    ...
    authoring: 'CourseLab + Verge3D',
    lms: 'Moodle',
    result: 'в одном электронном курсе объединены изучение устройства хроматографа, принципа его работы, интерактивные задания по хроматографии и практический модуль поверки.',
    gallery: [
  ...
  },
  {
    ...
    authoring: 'CourseLab + Verge3D',
    lms: 'Moodle',
    result: 'пользователь проходит полный практический сценарий: проверяет условия проведения работ, изучает состав установки, выполняет внешний осмотр и виртуальную поверку с фиксацией результатов.',
    gallery: [
  ...
  },
  {
    ...
    authoring: 'CourseLab + Verge3D',
    lms: 'Moodle',
    result: 'тренажер дает возможность изучить органы управления прибора и последовательность поверки в интерактивной среде до работы с реальным оборудованием.',
    gallery: [
  ...
  },
  {
    ...
    authoring: 'CourseLab + Verge3D',
    lms: 'Moodle',
    result: 'курс объединяет изучение измерительной установки, контроль условий выполнения работ, внешний осмотр и виртуальное выполнение процедуры поверки рулетки.',
    gallery: [
...
const extraProjects: Project[] = [
  {
    ...
    authoring: 'CourseLab + Verge3D',
    lms: 'Moodle',
    result: 'теория, спектроаналитическая таблица, подготовка пробы и практическая работа с оборудованием объединены в единый SCORM-курс.',
    gallery: [
  ...
  },
  {
    ...
    authoring: 'CourseLab + Verge3D',
    lms: 'Moodle',
    result: 'пользователь проходит последовательность от внешнего осмотра до виртуальной поверки, заполнения результатов и итогового тестирования.',
    gallery: [
          ...
          <div className="about-card">
            ...
            <div className="about-details">
              ...
              <div className="about-education">
                ...
                <div className="education-card education-card-wide">
